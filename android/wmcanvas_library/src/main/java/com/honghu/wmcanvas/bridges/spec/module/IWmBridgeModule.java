...
import com.honghu.wmcanvas.bridges.spec.AndroidOnly;

import org.json.JSONArray;
import org.json.JSONObject;

/**
 * <b>Bridge interface for WmCanvas bridge layer.</b>
 ...
 * We need such functionality to connect between WmCanvas C++ Render Layer and Javascript runtime. That's why "bridge" comes from.
 * </p>
...
public interface IWmBridgeModule<JSCallback> {
     ...
     * This will build relationship between WmCanvas.js and native view.
     * @param data
    ...
    /**
     * Set the context type for specified WmCanvas.
     * @param canvasId
     * @param type
     */
