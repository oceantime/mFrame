package com.taobao.wmcanvas.adapters.img.impl.fresco;
...
public class WmCanvasFrescoImageLoader implements IWmImageLoader {
    ...
    public WmCanvasFrescoImageLoader() {
        this(null, null);
    }

    public WmCanvasFrescoImageLoader(DraweeConfig draweeConfig) {
        this(null, draweeConfig);
    }

    public WmCanvasFrescoImageLoader(ImagePipelineConfig imagePipelineConfig) {
        this(imagePipelineConfig, null);
    }

    public WmCanvasFrescoImageLoader(ImagePipelineConfig imagePipelineConfig, DraweeConfig draweeConfig) {
