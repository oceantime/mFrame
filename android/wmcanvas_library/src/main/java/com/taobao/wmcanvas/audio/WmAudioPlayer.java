 ...
 */
public class WmAudioPlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {

    private static final String LOG_TAG = "WmAudioPlayer";
    ...
    private WmAudioHandler handler;          // The AudioHandler object
    ...
    private WmCanvasResult resultContext;
     ...
     * @param resultContext
     */
    public WmAudioPlayer(WmAudioHandler handler, String id, String file, WmCanvasResult resultContext) {
