...
public class WmFontConfigParser {
    ...
    private void readFallbackConfigFile() {
        try {
            ...
            Log.e("WmFontConfigParser", "readFallbackConfigFile " + e.getMessage());
        }
    }
    ...
    private void readConfigFile() {
        try {
            ...
            WmLog.e("WmFontConfigParser", e.getMessage());
        }
    }
    ...
    private void parseXML(Document doc) throws Exception {
        ...
        if (!root.getTagName().equals("familyset")) {
            WmLog.w("WmFontConfigParser", "Can't find familyset.");
            return;
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            for (int i = 0; i < length; ++i) {
                ...
                if (s == null) {
                    ...
                    //WmLog.w("WmFontConfigParser", "family name: " + s.getNodeValue());
                }

                NodeList fontNodes = ((Element) familyNode).getElementsByTagName("font");

                if (fontNodes == null) {
                    WmLog.w("WmFontConfigParser", "nameset or fileset is invalid.");
                    break;
                }
                ...
                for (int k = 0; k < aliasLength; ++k) {
                    ...
                    if (nameA == null || toA == null) {
                        ...
                        //WmLog.w("WmCanvas - WmFontConfigParser", "nameA: " + nameA + " toA: " + toA);
                    }
                    ...
                    for (String name : nameList) {
                        if (name.equals(toA.getNodeValue())) {
                            ...
                            //WmLog.w("WmCanvas - WmFontConfigParser", "alias " + nameA.getNodeValue() + " to: " + name);
                        }
                    }
            ...
            for (int i = 0; i < length; ++i) {
                ...
                if (familyNode instanceof Element) {
                    ...
                    if (namesetNodes == null
                        ...
                        WmLog.w("WmFontConfigParser", "nameset or fileset node doesn't exist.");
                        return;
                    }
