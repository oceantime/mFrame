...
public class WmCanvasResult<T> {
    public enum ResultCode {
        NO_RESULT, OK, ERROR
    }

    public interface Listener {
        void onResult(WmCanvasResult result, ResultCode code, Object message);
    ...
    public WmCanvasResult() {
        this.mCallbackId = "";
    }

    public WmCanvasResult(T data) {
        this.mCustomData = data;
        this.mCallbackId = "";
    }

    public WmCanvasResult(String callbackId, Listener listener) {
