...
extern void prepareCases( std::unordered_map< std::string,std::function<void(std::shared_ptr<wmcanvas::GCanvas> canvas,  GCanvasContext *mCanvasContext,int width,int height)>>  &testCases);

int main(int argc, char *argv[])
{
    std::unordered_map< std::string,std::function<void(std::shared_ptr<wmcanvas::GCanvas> canvas,  GCanvasContext *mCanvasContext,int width,int height)>> testCases;
