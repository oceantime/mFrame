...
namespace wmcanvas {
    ...
    int ParseTokensBase64(const char *&pos, std::string &str) {
        ...
        wmcanvas::Base64DecodeBuf((char *) str.c_str(), begin, len);
        *((char *) str.c_str() + len) = '\0';
        return len;
    }
...
//new
    int checkFramebufferStatus(WmCanvas *obj, const char *&p) {
        ...
        obj->setSyncResult(wmcanvas::toString(status));
        return kContinue;
    }
...
//new
    ...
    int createBuffer(WmCanvas *obj, const char *&p) { // createBuffer;
        ...
        obj->setSyncResult(wmcanvas::toString(buffer));
        return kContinue;
    }
    ...
    int createFramebuffer(WmCanvas *obj, const char *&p) { // createFramebuffer;
        ...
        obj->setSyncResult(wmcanvas::toString(framebuffer));
        return kContinue;
    }
    ...
    int createProgram(WmCanvas *obj, const char *&p) {//createProgram
        ...
        obj->setSyncResult(wmcanvas::toString(program));
        return kContinue;
    }
    ...
    int createRenderbuffer(WmCanvas *obj, const char *&p) { // createRenderbuffer;
        ...
        obj->setSyncResult(wmcanvas::toString(renderBuffer));
        return kContinue;
    }
    ...
    int createShader(WmCanvas *obj, const char *&p) { // createShader1;
        ...
        obj->setSyncResult(wmcanvas::toString(shader));
        return kContinue;
    }
    ...
    int createTexture(WmCanvas *obj, const char *&p) { // createTexture
        ...
        obj->setSyncResult(wmcanvas::toString(texture));
        return kContinue;
    }
...
//new
    ...
    int getActiveAttrib(WmCanvas *obj, const char *&p) {//getActiveAttrib
        ...
        if (len == 0) {
            ...
            result.append(",");
            result.append(wmcanvas::toString(size));
            result.append(",");
            result.append(name);
    ...
    int getAttachedShaders(WmCanvas *obj, const char *&p) {
        ...
        std::string result;
        for (int i = 0; i < size; i++) {
            result.append(wmcanvas::toString(shader[i]));
            if (i < size - 1)
                result.append(",");
        }
...
//new
    int getBufferParameter(WmCanvas *obj, const char *&p) {
        ...
        if (params == -1) {
            ...
            result += ",";
            result += wmcanvas::toString(params);
            obj->setSyncResult(result);
        }
...
//new
    int getError(WmCanvas *obj, const char *&p) {
        ...
        obj->setSyncResult(wmcanvas::toString(error));
        return kContinue;
    }
    ...
    int getParameter(WmCanvas *obj, const char *&p) {
        ...
        switch (pname) {
            ...
            case GL_STENCIL_TEST: {
                ...
                std::string result(wmcanvas::toString(retType));
                result += ",";
                result += wmcanvas::toString(retValue);
                obj->setSyncResult(result);
                break;
            }
            ...
            case GL_STENCIL_WRITEMASK: {
                ...
                std::string result(wmcanvas::toString(retType));
                result += ",";
                result += wmcanvas::toString((unsigned int) iParams);
                obj->setSyncResult(result);
                break;
            }
            ...
            case GL_TEXTURE_BINDING_CUBE_MAP: {
                ...
                std::string result(wmcanvas::toString(retType));
                result += ",";
                result += wmcanvas::toString(iParams);
                obj->setSyncResult(result);
                break;
            }
            ...
            case GL_SAMPLE_COVERAGE_VALUE: {
                ...
                std::string result = wmcanvas::toString(retType);
                result += ",";
                result += wmcanvas::toString(fParams);
                obj->setSyncResult(result);
                break;
            }
            ...
            case GL_MAX_VIEWPORT_DIMS: //	Int32Array (with 2 elements)
            {
                ...
                for (int i = 0; i < 2; i++) {
                    result += ",";
                    result += wmcanvas::toString(values[i]);
                }
            ...
            case GL_VERSION: {
                ...
                std::string result = wmcanvas::toString(retType);
                result += ",";
                result += wmcanvas::toString(charResult);
            ...
            case GL_COMPRESSED_TEXTURE_FORMATS: {
                ...
                for (int i = 0; i < numFormats; i++) {
                    result += ",";
                    result += wmcanvas::toString((unsigned int) formats[i]);
                }
        ...
        switch (pname) {
            ...
            case GL_VALIDATE_STATUS: {
                if (params == -1) {
                    ...
                    result += ",";
                    result += wmcanvas::toString(params);
                    obj->setSyncResult(wmcanvas::toString(result));
                }
                break;
            }
                //returnType GLint
...
//new
    int getShaderPrecisionFormat(WmCanvas *obj, const char *&p) { // getShaderPrecisionFormat;
        ...
        if (range[0] == -1) {
            ...
            std::string result;
            for (int i = 0; i < 2; i++) {
                result.append(wmcanvas::toString(range[i]));
                result.append(",");
            }
            result.append(wmcanvas::toString(precision));
            ...
            if (loc == location) {
                ...
                switch (type) {
                    ...
                    case GL_SAMPLER_CUBE: {
                        ...
                        result = wmcanvas::toString(kReturnInt);
                        result.append(",");
                        result.append(wmcanvas::toString(iParam));
                        break;
                    }
                    case GL_INT_VEC2:
                    case GL_BOOL_VEC2:
                    ...
                    case GL_BOOL_VEC4: {
                        ...
                        result = wmcanvas::toString(kReturnIntArray);
                        LOG_D("end get");
                        ...
                        for (int i = 0; i < paraNum; i++) {
                            result.append(",");
                            LOG_D("num=%d,param=%d\n", i, iParams[i]);
                            result.append(wmcanvas::toString(iParams[i]));
                        }
                    ...
                    case GL_FLOAT: {
                        ...
                        result = wmcanvas::toString(kReturnFloat);
                        result.append(",");
                        result.append(wmcanvas::toString(fParam));
                        break;
                    }
                    ...
                    case GL_FLOAT_MAT4: {
                        ...
                        LOG_D("end get");
                        result = wmcanvas::toString(kReturnFloatArray);
                        ...
                        for (int i = 0; i < paraNum; i++) {
                            result.append(",");
                            LOG_D("num=%d,param=%f\n", i, fParams[i]);
                            result.append(wmcanvas::toString(fParams[i]));
                        }
        ...
        switch (pname) {
            ...
            case GL_CURRENT_VERTEX_ATTRIB: {
                ...
                if (params[0] == -1) {
                    ...
                    for (int i = 0; i < 4; i++) {
                        result += ",";
                        result += wmcanvas::toString(params[i]);
                    }
                    obj->setSyncResult(result);
                }
...
//    GLenum pname = tokens[1];
        ...
        obj->setSyncResult(wmcanvas::toString(value));
        return kContinue;
    }
...
//new
    ...
    int readPixels(WmCanvas *obj, const char *&p) {
        ...
        for (int i = 0; i < pixelSize; i++) {
            result += ",";
            result += wmcanvas::toString((unsigned int) (pixels[i] & 0xff));
        }
        obj->setSyncResult(result);
...
//new
    ...
    int texImage2D(WmCanvas *obj, const char *&p) { //  texImage2D0,0,3,3,0,a.bmp;
        ...
        if (6 == args) {
            ...
            {
                strncpy((char *) src.c_str(), p, strlen(p) - 1); //ȥ�����ֺ�
...
//////////////////////////////////////////////////////////////////////////
    ...
    int createVertexArrayOES(WmCanvas *obj, const char *&p) {
        ...
        obj->setSyncResult(wmcanvas::toString(array));
        return kContinue;
    }
