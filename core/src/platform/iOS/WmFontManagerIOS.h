...
public:
    ...
    float MeasureText(const char *text, unsigned int text_length, wmcanvas::GFontStyle *fontStyle);
    
    float* MeasureTextExt(const char *text, unsigned int text_length, wmcanvas::GFontStyle *fontStyle);
};
