 ...
 */
#include <jni.h>
/* Header for class com_honghu_wmcanvas_WmCanvasJNI */

#ifndef _Included_com_honghu_wmcanvas_WmCanvasJNI
#define _Included_com_honghu_wmcanvas_WmCanvasJNI
#ifdef __cplusplus
extern "C" {
#endif
...
JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_newCanvas(JNIEnv *,
                                                                    jclass,
                                                                    jstring,
                                                                    jint,
                                                                    jstring);

JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_freeCanvas(JNIEnv *,
                                                                     jclass,
                                                                     jstring);

/*
 * Class:     com_honghu_wmcanvas_WmCanvasJNI
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_setOrtho(JNIEnv *,
                                                                   jclass,
                                                                   jstring,
                                                                   jint, jint);
...
/*
 * Class:     com_honghu_wmcanvas_WmCanvasJNI_addPngTextureByStream
 * Method:    addPngTexture
 * Signature:
 * (Ljava/lang/Object;Ljava/lang/String;ILcom/taobao/gcanvas/WmCanvasTextureDimension;)Z
 */
JNIEXPORT jboolean JNICALL
Java_com_honghu_wmcanvas_WmCanvasJNI_addPngTextureByStream(JNIEnv *, jclass,
                                                         jstring, jbyteArray,
                                                         jint, jobject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_release(JNIEnv *,
                                                                  jclass);

JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_init(JNIEnv *,
                                                               jclass);
...
JNIEXPORT jboolean JNICALL
Java_com_honghu_wmcanvas_WmCanvasJNI_isFboSupport(JNIEnv *, jclass, jstring);
...
JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_setConfig(JNIEnv *je,
                                                                    jclass jc,
                                                                    jstring key,
                                                                    jint value);
...
JNIEXPORT void JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_registerCallback(JNIEnv *je, jclass jc, jstring soPath, jint version);

JNIEXPORT jint JNICALL Java_com_honghu_wmcanvas_WmCanvasJNI_getNativeFps(JNIEnv *je, jclass jc, jstring contextId);
