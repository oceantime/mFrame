...
* iOS  [WmCanvas](https://cocoapods.org/pods/WmCanvas)   [![CocoaPods Version](https://badge.fury.io/co/WmCanvas.svg)](https://badge.fury.io/co/WmCanvas)
...
- Scalable Architecture, easy to implement a WmCanvas bridge by yourself following the guide [Custom Native Bridge](https://alibaba.github.io/WmCanvas/docs/Custom%20Bridge.html) .
- Small size.

## Introduction

See the  [Introduction to WmCanvas](https://alibaba.github.io/WmCanvas/docs/Developer's%20Guide.html) for a detailed  introduction to WmCanvas.
...
|-------------|-------------------|-------------|-------------|
| corelib | `com.taobao.gcanvas:corelib:1.2.0` | `android/gcanvas_library/build/outputs/aar/gcanvas_library-ali-release.aar` | Core WmCanvas library with native rendering engine |
...
### Node
Follow [Node Guide](./node/README.md),  use WmCanvas in Node.js.  

### JavaScript
Try our [Playground](https://alibaba.github.io/WmCanvas/playground.html).
WmCanvas has browser-like canvas APIs, so almost all of the APIs are exactly same as HTML5 canvas. At this moment, we have already supported 90% of 2D APIs and 99% of WebGL APIs. You can find out those informations in [2D  APIs](https://alibaba.github.io/WmCanvas/docs/Graphics%202D.html) and [WebGL APIs](https://alibaba.github.io/WmCanvas/docs/WebGL.html).

## Documentation
Check [Documentation](https://alibaba.github.io/WmCanvas/docs/Introduction.html) for more information.

## Examples
We take [Weex](https://github.com/apache/incubator-weex) as example, code snippet of context 2d using `WmCanvas`.
```javascript
...
## Open Issues
If you encounter a bug with WmCanvas we would like to hear about it. Search the [existing issues]() and try to make sure your problem doesn’t already exist before opening a new issue. It’s helpful if you include the version of WmCanvas  and OS you’re using. Please include a stack trace and reduced repro case when appropriate, too.
